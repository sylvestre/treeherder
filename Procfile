...
worker_default: newrelic-admin run-program celery -A treeherder worker -Q default,cycle_data,calculate_durations,fetch_bugs,fetch_allthethings,,autoclassify,detect_intermittents --maxtasksperchild=50 --concurrency=3
